...
const organisations = [
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'NOS', label: 'National Overseas Scholarship', href: '#' },
      { code: 'NMBA', label: 'Nasha Mukt Bharat Abhiyaan', href: '#' },
      { code: 'NHAA', label: 'National Helpline Against Atrocities', href: '#' },
    ],
  },
];
